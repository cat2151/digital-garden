...
- リッチ化。[[Salamander Piano]] など[[CC BY]]な楽器で、よりリッチな音色で、userの音楽体験の満足度を高めたい。
- 妄想。インストールが楽、リッチ、を両立する手段としての、宣言的なインストールの仕組み。[[オーディオプラグイン]]や[[プラグインホスト]]も宣言的にインストール。まずPoCを小さく始める。以降で詳述。
